          ...
          <div className="relative bg-gradient-to-r to-transparent">
            ...
            <div className="container  lg:p-14 p-4">
              <div className="heading text-center mb-0">
                <h4 className="">BORRO by Liqueous</h4>
                <p>Maintain Ownership, Enhance Liquidity with OurBeneficial</p>
                <p>Ownership Retention Repurchase Option (BORRO)</p>
              </div>
              <div className="relative">
                <div className="absolute inset-0">
                  <img
                    src="/assets/images/Boro.svg"
              ...
              <div className=" flex justify-center text-center items-end ">
                <div className=" lg:w-[77%] lg:px-14 lg:pb-4 pb-2 px-2 w-full dark:bg-black ">
                  <p className="pt-30 lg:pt-0">
                    In an increasingly complex financial environment, accessing
                    liquidity in non-marginable securities without giving up
                    beneficial ownership can seem like an insurmountable
                    challenge. Conventional liquidity solutions often require
                    businesses to relinquish their rights, which can lead to a
                    loss of control and potential upside.
                  </p>
        ...
        <div className="relative container  lg:mt-[100px] mt-[50px] ">
          <div className="relative ">
            <div className="container   flex justify-center lg:my-[100px] my-[50px]">
              <div className="h-[24rem] w-[64rem] bg-[#eff6ff] rounded-xl flex justify-center items-center dark:border-2 dark:border-gray dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none  ">
          ...
          <div className=" container absolute top-0 left-0 z-10 flex justify-center pt-8">
            <div className="h-[20rem] lg:w-[58rem] rounded-xl bg-white flex justify-center items-center w-[18rem] dark:border-white/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none   ">
              <div className="w-[36rem] text-center ">
                ...
                <p>
                  At Liqueous, we have pioneered a groundbreaking solution -
                  BORRO - a liquidity solution that allows you to retain
                  beneficial ownership of your securities while accessing the
                  liquidity you need.
                </p>
                <ApplyNowButton />
              </div>
        ...
        <section className="bg-gradient-to-b from-white/[55%] to-transparent dark:from-white/5 ">
          <div className="container ">
            <div className="heading text-center">
              ...
              <h4>
                Why Choose BORRO{" "}
                <span className="text-primary">by Liqueous? </span>
              </h4>

              <p>
                Our Beneficial Ownership Retention Repurchase Option (BORRO) is
                a unique liquidity
              </p>
              <p>
                solution designed with the needs of businesses like yours in
                mind.
              </p>
            </div>
          </div>
          <div className="flex justify-center">
            <div className="lg:mt-12 mt-0 lg:mb-8 mb-0 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8   mx-4 ">
              <div className="max-w-sm p-6 bg-white border border-white rounded-2xl shadow dark:border-white/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none ">
                <svg
                  width="28"
                  height="28"
                  viewBox="0 0 28 28"
                ...
                <p className="mb-3 font-normal text-gray dark:text-gray-400">
                  {" "}
                  Our BORRO program is a 6 month to 10-year liquidity solution
                  that provides businesses with access to the capital they need,
                  when they need it.
                </p>
              </div>
              ...
              <div className="max-w-sm p-6 bg-white border border-white rounded-2xl shadow dark:border-white/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none">
                ...
                <p className="mb-3 font-normal text-gray dark:text-gray-400">
                  {" "}
                  With BORRO, you retain beneficial ownership of your securities
                  during the term period. This means you maintain control and
                  continue to participate in the potential upside of your
                  securities
                </p>
              </div>
              ...
              <div className="max-w-sm p-6 bg-white border border-white rounded-2xl shadow dark:border-white/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none">
                ...
                >
                  <path
                    d="M13.986 1.5762e-05C11.2177 0.0027841 8.51229 0.826222 6.21184 2.36624C3.9114 3.90627 2.11916 6.09373 1.06168 8.65214C0.00419843 11.2106 -0.271052 14.025 0.270722 16.7399C0.812495 19.4547 2.14697 21.9479 4.10546 23.9044C6.06395 25.861 8.55854 27.193 11.2739 27.732C13.9892 28.2711 16.8035 27.993 19.3608 26.933C21.9182 25.8729 24.1038 24.0785 25.6415 21.7765C27.1793 19.4746 28 16.7684 28 14C28.0009 12.1601 27.639 10.338 26.9349 8.63812C26.2307 6.93823 25.1983 5.3939 23.8966 4.09351C22.5949 2.79312 21.0496 1.76222 19.349 1.0598C17.6484 0.357388 15.8259 -0.00274577 13.986 1.5762e-05ZM19.922 22.4L14 18.83L8.07801 22.4L9.64601 15.666L4.42401 11.144L11.312 10.556L14 4.20002L16.688 10.542L23.576 11.13L18.354 15.652L19.922 22.4Z"
                    fill="#5C96FD"
                  />
                </svg>
                ...
                <p className="mb-3 font-normal text-gray dark:text-gray-400">
                  {" "}
                  Our BORRO program offers flexible terms, allowing us to tailor
                  the solution to your unique needs and financial situation.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mt-[50px]">
            ...
            <div className="grid items-center gap-2 md:grid-cols-3 lg:grid-cols-2 xl:items-start">
              <div className="lg:order-2 order:1 md:col-span-2 lg:col-auto">
                <div className="text-center font-semibold ltr:md:text-left rtl:md:text-right lg:p-10 p-0 ">
                  <p className="pt-2">
                    Navigating the financial landscape can be complex, but with{" "}
                    <span className="text-primary">BORRO</span> by Liqueous, it
                    doesn’t have to be. By retaining beneficial ownership of
                    your securities while accessing much-needed liquidity, you
                    can navigate market dynamics with confidence, seize growth
                    opportunities, and drive your business towards success.
                  </p>

                  <p className="pt-7">
                    {" "}
                    At Liqueous, we believe in creating innovative solutions
                    that empower businesses. Our BORRO program is a testament to
                    this belief, offering a unique liquidity solution that puts
        ...
        <div className="relative container  mt-[100px] mb-[50px] lg:mb-0  ">
          <div className="relative ">
            <div className="container   flex justify-center lg:my-[100px]">
              <div className="lg:h-[15rem] h-[26rem] w-[64rem] bg-[#eff6ff] rounded-xl flex justify-center items-center dark:border-2 dark:border-gray dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none  ">
                    ...
                    <div className="flex-auto w-75  text-center lg:text-start">
                      <h2 className="text-4xl font-extrabold leading-normal sm:text-6xl lg:text-[50px] lg:leading-[60px]">
                        <span className="text-primary text-xl">
                          SAME DAY QUOTES, NO OBLIGATIONS
                        </span>{" "}
                      </h2>
                      <h2 className="text-2xl font-extrabold text-black dark:text-white">
                        Discover the Liqueous advantage with{" "}
                        <span className="text-secondary">BORRO</span> today.
                      </h2>
                    </div>
                  </div>
