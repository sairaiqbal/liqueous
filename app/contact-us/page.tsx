...
const ContactUs = () => {
  ...
  return (
    ...
    <div className="  bg-white dark:bg-gray-dark">
        ...
        <div className="relative ">
          ...
          <div className="container  pt-14">
            ...
            <div className="heading text-center mb-6">
                ...
                <h4> <span className="text-primary"> Customized </span> Financial Solutions</h4>
            ...
            <div className=" flex justify-center text-center items-end ">
                ...
                <div className=" lg:w-[77%] lg:px-14 lg:pb-4 pb-2 px-2 w-full dark:bg-black ">
                    ...
                    <p className="pt-30 lg:pt-6">
                        We understand that navigating the financial landscape can be daunting. Whether you’re
                        considering an equity line of credit, exploring a private block sale, or seeking
                        comprehensive financial solutions, our team at Liqueous is ready to help. We’re committed to
                        providing tailored solutions that align with your unique financial needs and business goals.
            ...
            <div className=" container px-0  flex justify-center pt-8 mt-[50px] mb-[100px] ">
                <div
                    className="lg:h-[13rem] h-[22rem] lg:w-[60rem] rounded-xl bg-white border-[36px] border-[#f3f3fe] flex justify-center items-center w-[22rem] dark:border-white/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none   ">

                    <div className="w-11/12  ">

                        <div className="flex lg:flex-row flex-col lg:gap-0  gap-2  justify-between w-full  ">
                            <div className="flex items-center justify-center  ">
                                <div className="flex-auto w-75  text-center lg:text-start">
                                    <h2
                                        className="text-4xl font-extrabold leading-normal sm:text-6xl lg:text-[50px] lg:leading-[60px]">
                                        <span className="text-primary text-xl">Call us Today, </span> </h2>
                                    <h2 className="text-2xl font-extrabold text-black dark:text-white lg:mb-6 mb-0">Our
                                        <span className="text-secondary">Toll Free</span> Number is:
                            ...
                            <div className="flex items-center w-25 ">
                                ...
                                <a href="tel:+18665303357"
                                    className="text-primary lg:text-2xl text-xl font-bold ml-4">(+1)866-530-3357</a>
                            </div>
                        </div>
            ...
            <div className="container my-[100px]">
                <div className="heading text-center">
                    ...
                    <p> our services, schedule a one to one meeting: </p>
                ...
                <div className="container  flex justify-center">
                    ...
                    <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-3   mx-4 lg:mx-0">
                        ...
                        <div
                            className="max-w-sm p-6 bg-[#fcfcfd] border border-white rounded-2xl shadow dark:border-white/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none">
                            ...
                            <h5 className="my-3 text-2xl font-semibold tracking-tight text-black dark:text-white">Advisory
                                Services</h5>

                            <p className="mb-3 font-normal text-gray dark:text-gray-400">Our advisory services are designed to provide you with valuable insights and
                                recommendations. </p>


                            <a href="https://calendly.com/jacob-n2" target="_blank" className="flex justify-center"> 
                                <button type="button" className="btn ml-2 mt-2 py-3 px-6 whitespace-nowrap text-white rounded-full">
                        ...
                        <div
                            ...
                            <h5 className="my-3 text-2xl font-semibold tracking-tight text-black dark:text-white">Business
                                Consultation
                            </h5>

                            <p className="mb-3 font-normal text-gray dark:text-gray-400"> Explore opportunities for
                                collaboration, partnerships, or discuss your business needs with us. </p>
                            <a href="https://Calendly.com/robert-ksk" target="_blank"className="flex justify-center"> 
                                <button type="button" className="btn ml-2 mt-2 py-3 px-6 whitespace-nowrap text-white rounded-full">
                                    Schedule meeting</button>
                            </a>
                        </div>
                        <div
                            ...
                            <h5 className="my-3 text-2xl font-semibold tracking-tight text-black dark:text-white">Technical
                                Support
                            </h5>

                            <p className="mb-3 font-normal text-gray dark:text-gray-400">Discuss technical issues or queries
                                about our products or services with technical support team. </p>
                            <a href="https://calendly.com/chaudhry-umar" target="_blank"className="flex justify-center"> 
                                <button type="button" className="btn ml-2 mt-2 py-3 px-6 whitespace-nowrap text-white rounded-full">
                                    Schedule meeting</button>
                            </a>
                        </div>
            ...
            <div className="flex justify-center ">
                <div className="grid items-center gap-16 lg:grid-cols-2 xl:items-start  ">
                    <div className="lg:order-2 order:1 md:col-span-2 lg:col-auto flex justify-center ">
                        <div className="text-center font-semibold ltr:md:text-left rtl:md:text-right  ">
                            <div
                                className=" flex justify-center items-center  lg:w-[28rem] h-[23rem] w-[22rem]  bg-[#f3f3fe]  rounded-xl ">
                                <div className="lg:w-[24rem] h-[19rem] w-[18rem] bg-white rounded-xl p-7 pt-10">
                                    ...
                                    <h5
                                        className="my-5 text-2xl font-semibold tracking-tight text-black dark:text-white">
                                        Our Hours</h5>

                                    <p className="mb-2 font-normal text-gray dark:text-gray-400">
                                        We operate Monday to Friday, from 9:00 AM </p>
                                    <p className="mb-2 font-normal text-gray dark:text-gray-400"> to 5:00 PM Eastern
                                        Time. We are closed on</p>
                                    <p className="mb-3 font-normal text-gray dark:text-gray-400"> public holidays.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="text-center font-semibold ltr:md:text-left rtl:md:text-right  ">
                            <div
                                ...
                                <div className="lg:w-[24rem] h-[19rem] w-[18rem] bg-white rounded-xl p-7 pt-10">
                                    ...
                                    <p className="mb-2 font-normal text-gray dark:text-gray-400">
                                        Liqueous LP</p>
                                    <p className="mb-2 font-normal text-gray dark:text-gray-400"> 8 THE GRN NUM 15337
                                    </p>
                                    <p className="mb-3 font-normal text-gray dark:text-gray-400"> DOVER, DE 19901 </p>
                                    <p className="mb-3 font-normal text-gray dark:text-gray-400"><a
                                            href="tel:+18665303357"> Toll Free No: (+1)866-530-3357 </a> </p>
      ...
      <div className="relative container mb-[28rem]">
        <div className="relative ">
