...
const ContactUs = () => {
  return (
                ...
                <div className=" flex justify-center text-center items-end ">
                    ...
                    <div className=" lg:w-[77%] lg:px-14 lg:pb-4 pb-2 px-2 w-full dark:bg-black ">
                        ...
                        <p className="pt-30 lg:pt-6">
                            ...
                            considering an equity line of credit, exploring a private block purchase, or seeking
        ...
        <div className="container my-[100px]">
            ...
            <div className="flex justify-center">
                <div className="grid items-center gap-8 lg:gap-16 md:grid-cols-1 lg:grid-cols-1 xl:items-start ">
                    <div className="lg:order-2 order:1 md:col-span-2 lg:col-auto flex justify-center ">
                        <div className="text-center font-semibold ltr:md:text-left rtl:md:text-right  ">
                            <div
                                className=" flex justify-center items-center   h-[9rem] w-[22rem] lg:w-[28rem] bg-[#f3f3fe]  rounded-xl ">
            ...
            <div className="flex justify-center">
                <div className="mt-10 text-center">
                    <p className=" font-normal text-gray dark:text-gray-400 ">Alternatively, you can fill out the contact
                        form below, and one of </p>
                    <p className=" mb-3font-normal text-gray dark:text-gray-400 ">our <span
                            className="text-secondary">representatives</span> will get back to you as soon as possible.</p>
                </div>
            </div>
    ...
    <div className="relative ">
            <div
                className="container h-[470px]  lg:w-4/5 bg-gradient-to-r to-transparent rounded-3xl lg:py-[50px] flex justify-around">
    ...
    <div className="relative container  lg:mt-[350px] mt-[24rem] ">
        {/* <!-- <div class="relative ">
            <div class="container   flex justify-center lg:my-[100px]">
                <div
                    class="h-[28rem] w-[64rem] bg-[#eff6ff] rounded-xl flex justify-center items-center dark:border-2 dark:border-gray dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none  ">
        ...
        {/* <!-- <div class=" flex justify-center lg:mb-[100px] mb-[80px]">
            <div
                class="lg:h-[24rem] h-[30rem] lg:w-5/6 w-full border-[28px] border-[#f3f3fe] rounded-xl bg-white flex justify-center items-center  dark:border-white/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none   ">

                <div class="w-5/6 text-center ">
                    <div class="flex justify-center lg:pb-5 ">
                    ...
                    <div>
                        <p class="text-xl">
                            Follow us on our <span class="text-primary">social media </span> platforms  </p>
                          <p class="text-xl">to stay updated with our latest news and offerings:</p>  
                      
                    </div>
                   <div class="flex justify-center lg:block ">
                    <div class="lg:flex justify-around lg:my-8  ">
                        <div class="flex py-2">
