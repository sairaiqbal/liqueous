      ...
      <div className="overflow-x-hidden  bg-white dark:bg-gray-dark">
          ...
          <div className="relative bg-gradient-to-r to-transparent">
            ...
            <div className="container  lg:p-14 p-4">
              ...
              <div className="relative">
                <div>
                  <img
                    src="/assets/images/e-Hexagons.svg"
              ...
              <div className=" flex justify-center text-center items-end ">
                <div className=" lg:w-[77%] lg:px-14 lg:pb-4 pb-2 px-2 w-full dark:bg-black ">
                  <p className="pt-30 lg:pt-3">
                    In a rapidly evolving global marketplace, maintaining a
                    strong cash flow and securing timely financing can be a
                    significant challenge for publicly traded companies.
                    Traditional funding mechanisms such as convertible debt
                    structures often come with hidden costs and can lead to
                    unpredictable dilution, disrupting your company’s journey
        ...
        <div className="relative container  lg:mt-[100px] mt-[50px] ">
          ...
          <div className=" container absolute top-0 left-0 z-10 flex justify-center pt-8">
            <div className="h-[20rem] lg:w-[60rem] rounded-xl bg-white flex justify-center items-center md:w-[39rem] w-[18rem] dark:border-white/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none   ">
              <div className="w-[36rem] text-center ">
                ...
                <p>
                  At <span className="text-primary">Liqueous</span>, we
                  recognize these complexities and have crafted a unique
                  solution - Equity Lines of Credit (ELOC) - designed to equip
                  businesses with the financial agility they need to seize
                  growth opportunities and navigate market dynamics with
                  confidence.
                </p>
                <ApplyNowButton />
              </div>
          ...
          <div className="container ">
            <div className="heading text-center">
              ...
              <h4 className="font-extrabold">
                <span className="text-primary">Equity Lines</span> of Credit?
              </h4>
              <p>
                {" "}
              ...
              <p>
                {" "}
                liquidity solution designed with the needs of businesses like
                yours in mind.{" "}
              </p>
            </div>
        ...
        <div className=" container flex justify-center mt-[50px] ">
          <div className="lg:h-[13rem] h-[25rem] lg:w-full  rounded-xl bg-white flex justify-center items-center border-[26px] border-[#eff6ff] dark:border-white/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none   ">
            <div className="w-11/12  ">
              <div className="flex items-center justify-center px-6 text-center ">
                <p>
                  Our <span className="text-secondary">ELOCs</span> are
                  specifically tailored to cater to a diverse range of
                  enterprises, from microcap to mid- market. They are an ideal
                  solution for accessing growth capital and fostering
                  aftermarket presence and investor engagement. Experience the
                  advantages of our tailored financing solutions and unlock your
                  company’s full potential with a partner committed to your
                  success.
                </p>
              </div>
            </div>
        ...
        <div className=" container flex justify-center lg:mt-[100px] mt-[50px]  ">
          <div className="lg:h-[16rem] h-[30rem] w-full rounded-xl bg-white flex justify-center items-center border-[26px] border-[#eff6ff]  dark:border-white/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none   ">
            <div className="w-11/12  ">
              <div className="lg:flex justify-between ">
                ...
                <div className="flex-1 lg:w-[22rem] ">
                  <p>
                    Our Equity Lines of Credit are carefully crafted to align
                    with your business’s unique needs and strategic goals,
                    offering you a financial tool that not only meets your
                    current requirements but also empowers your future growth.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="lg:order-2 order:1 md:col-span-2 lg:col-auto">
                <div className="text-center font-semibold md:text-left lg:text-left lg:p-10 ">
                  <p className="lg:pt-16 lg:px-0 px-4">
                    The world of finance is complex, but navigating it doesn’t
                    have to be. With our Equity Lines of Credit, you can secure
                    the capital you need, maintain control over your company’s
                    financial future, and create a growth trajectory that aligns
                    with your vision.
                  </p>
        ...
        <div className=" container  flex justify-center lg:mt-[100px] my-[50px] ">
          <div className="lg:h-[13rem] h-[22rem] w-full rounded-xl bg-white flex justify-center items-center  border-[26px] border-[#eff6ff]  dark:border-white/10 dark:bg-transparent dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-transparent dark:!shadow-none   ">
            <div className="w-11/12  ">
              <div className="lg:flex justify-between ">
                <div className="flex items-center justify-center ">
                  <div className="flex-auto w-65 text-center lg:text-start ">
                    ...
                    <h2 className="text-2xl font-extrabold text-black dark:text-white">
                      {" "}
                      Discover the{" "}
                      <span className="text-primary">Liqueous </span>advantage
                      today..
                    </h2>
                  </div>
                </div>
